...
Usage:
    uv run python -m strata_api.pipeline.neighborhoods [--amenities]

Writes quartiere.geojson + noise.geojson to apps/web/public/data and copies
quartiere.geojson to apps/api/data/neighborhoods for the API router.
